...
public abstract class GameLevel implements ActionListener 
{
	...
	protected Score scoreCounter;								// Keeps track of the score
	 ...
	 */
	protected GameLevel(TurnsTakenCounterLabel counterLabel,Score points, int cardsToGuess, JFrame mainFrame)
	{
	...
	/**
	 * When there are no more plays left to make.
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			Card card = this.turnedCardsBuffer.get(i);
			card.turnDown();
		}
